...
* Updated Nuitka: 4.1.1 → 4.1.3.
* Added PyOpenGL-accelerate to dependencies.
...
* Added File → Config → Import and restart and Clear and restart, which
  relaunch the UI automatically after the configuration operation.
...
* Fixed host computer sleep / wake (USB suspend/resume)
  * Bumped pyjoulescope_driver from 2.3.0 to 2.3.2 with JS320 FW 1.1.5.
...
* Bumped versions:
  * PySide6-QtAds from 4.4.1.1 to 4.5.0
  * PySide6 from 6.10.0 to 6.10.1
